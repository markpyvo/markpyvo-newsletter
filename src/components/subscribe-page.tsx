  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <main className="flex-1 flex flex-col items-center px-5 pt-10 pb-16 max-w-md mx-auto w-full">
        ...
        {/* Headshot — no rounded corners */}
        <div className="w-full overflow-hidden mb-6 bg-gray-100">
          <img
            src="/mark-pro.png"
            alt="Mark"
        ...
        <div className="flex items-center gap-3 mb-5">
          <a href="https://www.linkedin.com/in/markpyvovarov/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
            className="w-10 h-10 bg-gray-900 rounded-xl flex items-center justify-center hover:opacity-80 transition-opacity">
